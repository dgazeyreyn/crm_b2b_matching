with
    matches as (select * from {{ ref("stg_matching_results__zi_company_id") }}),
    ...
    dates as (select * from {{ ref("stg_matching_results__match_date") }}),

    algo_ver as (select * from {{ ref("stg_matching_results__algorithm_version") }}),
